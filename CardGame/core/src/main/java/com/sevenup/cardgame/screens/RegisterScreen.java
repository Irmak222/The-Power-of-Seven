...
public class RegisterScreen implements Screen{
    ...
    public void show() {
        ...
        background = new Texture(Gdx.files.internal("RegisterScreen.png")); // background image
        ...
        Label confirmPasswordLabel = new Label("Confirm Password:", labelStyle);
        Label accountLabel = new Label("Already have an account? ", labelStyle);
        ...
        final TextField confirmPasswordField = new TextField("", fieldStyle);
        ...
        // Login link
        Label loginLink = new Label("Login", linkStyle);

        // When register button is clicked and user succesfully registered, the home screen is opened
        ...
        // Password row
        table.add(passwordLabel).width(260).padBottom(20).padLeft(50);
        table.add(passwordField).width(300).height(54).padBottom(20).padLeft(50);
        table.row();

        // Confirm Password row
        table.add(confirmPasswordLabel).width(260).padBottom(40).padLeft(50);
        table.add(confirmPasswordField).width(300).height(54).padBottom(40).padLeft(50);
        table.row();
        
        // Register button row
        table.add(registerButton).colspan(2).width(320).height(76).padLeft(260).padBottom(30).padLeft(50);
        table.row();

        // "Already have an account? Login " link row
        Table linkTable = new Table();
        linkTable.add(accountLabel);
        linkTable.add(loginLink);
        table.add(linkTable).colspan(2).padLeft(50).height(50).padRight(50);
